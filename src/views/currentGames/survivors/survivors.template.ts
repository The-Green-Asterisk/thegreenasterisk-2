            ...
            <section class="current-games-survivors">
                ...
                <div class="player-card">
                    ...
                    <div>
                        ...
                        <p>Dylan is relatively newer to DnD but has always loved tabletop and role-playing games. He likes to dive headfirst into his characters and will use any excuse to pull out a horrible, botched accent. If he's not rolling a d20, you can find him working at the hospital, at the gym, or picking up a big rock outside to look at all the bugs that were hiding under it. He also has a collection of horrible t-shirts that he wears proudly and seems to pull out of thin air.</p>
